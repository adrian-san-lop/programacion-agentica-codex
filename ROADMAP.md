...
| Costes, Prompt Caching y compactación | Parcial | [`docs/01-context-engineering/05-costes-basicos-de-llm.md`](docs/01-context-engineering/05-costes-basicos-de-llm.md) · [`docs/01-context-engineering/06-prompt-caching.md`](docs/01-context-engineering/06-prompt-caching.md) · [`Compactación de contexto en Codex`](docs/01-context-engineering/08-compactacion-de-contexto-en-codex.md) | Mantener separadas las reglas de suscripción Business, la API, el caching y la compactación; revisar fuentes cuando cambie el producto |
